...
data_file_name = 'nyka_top_brands_cosmetics_product_reviews.csv'
...
# Define the path for the vectorizer, and classifier files based on the dataset file name
...
X_train, X_test, y_train, y_test = train_test_split(X_resampled.flatten(), y_resampled, test_size=0.4, random_state=42)
